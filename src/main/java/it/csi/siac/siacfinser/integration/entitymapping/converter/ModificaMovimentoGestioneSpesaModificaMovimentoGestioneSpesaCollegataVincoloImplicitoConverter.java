...
@Component
public class ModificaMovimentoGestioneSpesaModificaMovimentoGestioneSpesaCollegataVincoloImplicitoConverter 
	extends BaseFinDozerConverter<ModificaMovimentoGestioneSpesa, SiacTModificaFin> {

	public ModificaMovimentoGestioneSpesaModificaMovimentoGestioneSpesaCollegataVincoloImplicitoConverter() {
		...
		if(source != null) {
			...
			if(siacTMovgestTsDetModFin != null) {
				...
				if(CollectionUtils.isNotEmpty(modificheCollegate)) {
					...
					mod.setVincoloEsplicito(Boolean.FALSE);
