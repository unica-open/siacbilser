...
@NamedQuery(name="SiacRVincoloAttrFin.findAll", query="SELECT s FROM SiacRVincoloAttrFin s")
public class SiacRVincoloAttrFin extends SiacTEnteBase {
