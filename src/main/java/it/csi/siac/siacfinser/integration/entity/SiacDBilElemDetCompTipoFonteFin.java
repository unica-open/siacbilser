...
@NamedQuery(name="SiacDBilElemDetCompTipoFonteFin.findAll", query="SELECT s FROM SiacDBilElemDetCompTipoFonteFin s")
public class SiacDBilElemDetCompTipoFonteFin extends SiacTEnteBase {
	 ...
	 */
	public SiacDBilElemDetCompTipoFonteFin() {
	}
