...
@NamedQuery(name="SiacDBilElemDetCompTipoImpFin.findAll", query="SELECT s FROM SiacDBilElemDetCompTipoImpFin s")
public class SiacDBilElemDetCompTipoImpFin extends SiacTEnteBase {
	 ...
	 */
	public SiacDBilElemDetCompTipoImpFin() {
	}
