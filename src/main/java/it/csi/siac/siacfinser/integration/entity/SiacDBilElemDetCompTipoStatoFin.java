...
@NamedQuery(name="SiacDBilElemDetCompTipoStatoFin.findAll", query="SELECT s FROM SiacDBilElemDetCompTipoStatoFin s")
public class SiacDBilElemDetCompTipoStatoFin extends SiacTEnteBase {
	 ...
	 */
	public SiacDBilElemDetCompTipoStatoFin() {
	}
