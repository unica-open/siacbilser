...
@NamedQuery(name="SiacDBilElemDetCompTipoFaseFin.findAll", query="SELECT s FROM SiacDBilElemDetCompTipoFaseFin s")
public class SiacDBilElemDetCompTipoFaseFin extends SiacTEnteBase {
	 ...
	 */
	public SiacDBilElemDetCompTipoFaseFin() {
	}
