...
@NamedQuery(name="SiacDBilElemDetCompTipoDefFin.findAll", query="SELECT s FROM SiacDBilElemDetCompTipoDefFin s")
public class SiacDBilElemDetCompTipoDefFin extends SiacTEnteBase {
	 ...
	 */
	public SiacDBilElemDetCompTipoDefFin() {
	}
