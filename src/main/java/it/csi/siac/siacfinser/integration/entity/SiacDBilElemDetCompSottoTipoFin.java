...
@NamedQuery(name="SiacDBilElemDetCompSottoTipoFin.findAll", query="SELECT s FROM SiacDBilElemDetCompSottoTipoFin s")
public class SiacDBilElemDetCompSottoTipoFin extends SiacTEnteBase {
	 ...
	 */
	public SiacDBilElemDetCompSottoTipoFin() {
	}
