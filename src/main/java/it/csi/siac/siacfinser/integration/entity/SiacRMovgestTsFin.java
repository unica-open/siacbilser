...
public class SiacRMovgestTsFin extends SiacTEnteBase {
	...
	//SIAC-8650
	@OneToMany(mappedBy = "siacRMovgestTs")
	...
	public List<SiacRModificaVincolo> getSiacRModificaVincolo() {
		return siacRModificaVincolos;
	}

	public void setSiacRModificaVincolo(List<SiacRModificaVincolo> siacRModificaVincolos) {
		this.siacRModificaVincolos = siacRModificaVincolos;
	}
