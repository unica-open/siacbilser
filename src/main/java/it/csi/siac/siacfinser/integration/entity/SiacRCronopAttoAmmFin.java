...
@NamedQuery(name="SiacRCronopAttoAmmFin.findAll", query="SELECT s FROM SiacRCronopAttoAmm s")
public class SiacRCronopAttoAmmFin extends SiacTEnteBase {
	 ...
	 */
	public void setSiacTCronop(SiacTCronopFin siacTProgramma) {
