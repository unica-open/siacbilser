...
public class RicercaClassiSiacService extends 
		AbstractBaseService<RicercaSoggetti, RicercaSoggettiResponse>
{
	...
	protected void init()
	{
		final String methodName = "RicercaClassiSiacService : init()";
...
//	}
	...
	public void execute()
	{
		final String methodName = "RicercaClassiSiacService - execute()";
