...
//	}
	...
	protected void checkServiceParam() throws ServiceParamError {		
		...
		} else if(modalitaPagamentoSoggetto == null || (modalitaPagamentoSoggetto.getUid() == 0 && StringUtilsFin.isEmpty(modalitaPagamentoSoggetto.getCodiceModalitaPagamento()) )){
		...
		} else if(modalitaPagamentoSoggetto != null && !StringUtilsFin.isEmpty(modalitaPagamentoSoggetto.getCodiceModalitaPagamento())){
			    // nel caso ci sia il codice inserito deve 
			    // essere un numero
			    if(!StringUtilsFin.contieneSoloNumeri(modalitaPagamentoSoggetto.getCodiceModalitaPagamento())){
