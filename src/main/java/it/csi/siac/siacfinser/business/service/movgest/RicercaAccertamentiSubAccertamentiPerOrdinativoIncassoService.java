...
public class RicercaAccertamentiSubAccertamentiPerOrdinativoIncassoService extends AbstractBaseService< RicercaAccertamentiSubAccertamenti,  RicercaAccertamentiSubAccertamentiResponse>{
	...
	@Override
	protected void init() {
		final String methodName = "RicercaAccertamentiSubAccertamentiPerOrdinativoIncassoService : init()";
	...
	public void execute() {
		...
		//Integer totAccertamentiTrovati = 0;
		
		//Elimino dai parametri il codice debitore, perchè non influenzi le query successive
		//lo salvo in una variabile; servirà dopo come parametro di filtro
		String codiceSoggettoOrdinativo = paramRic.getCodiceDebitore();
		paramRic.setCodiceDebitore(null);
		...
		listaAccertamenti = accertamentoOttimizzatoDad.ricercaAccertamentiSubAccertamentiOPTPerOrdinativoIncasso(req.getEnte(), 
																									  req.getRichiedente(), 
																									  paramRic, 
																									  numPagina, 
																									  numRisPerPagina,
																									  codiceSoggettoOrdinativo,
																									  res);
