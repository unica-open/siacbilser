...
public class RicercaSinteticaAccertamentiSubAccertamentiService extends AbstractBaseService< RicercaSinteticaAccertamentiSubAccertamenti,  RicercaSinteticaAccertamentiSubAccertamentiResponse>{
	...
	public RicercaSinteticaAccertamentiSubAccertamentiResponse executeService(RicercaSinteticaAccertamentiSubAccertamenti serviceRequest) {
	...
	public void execute() {
		...
		if(totAccertamentiTrovati!=null && totAccertamentiTrovati > 0){
			listaAccertamenti = accertamentoOttimizzatoDad.ricercaSinteticaAccertamentiSubAccertamenti(req.getEnte(), req.getRichiedente(), paramRic, numPagina, numRisPerPagina,datiOperazione);
