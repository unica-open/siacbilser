...
/**
 * The Class CancellaRigaSpesaService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class CancellaRigaSpesaService extends CheckedAccountBaseService<CancellaRigaSpesa, CancellaRigaSpesaResponse> {
	...
	protected void checkServiceParam() throws ServiceParamError {
		...
		checkNotNull(dett, ErroreCore.PARAMETRO_NON_INIZIALIZZATO.getErrore("dettaglio uscita programma"));
		checkCondition(dett.getUid()!=0, ErroreCore.PARAMETRO_NON_INIZIALIZZATO.getErrore("uid dettaglio uscita programma"));
	}
	...
	@Override
	@Transactional
	public CancellaRigaSpesaResponse executeService(CancellaRigaSpesa serviceRequest) {
	...
	protected void execute() {
		cronoprogrammaDad.cancellaDettaglioUscitaCronoprogramma(dett);
