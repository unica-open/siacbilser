...
public class AggiornaNotaCreditoIvaEntrataService extends CrudSubdocumentoIvaEntrataBaseService<AggiornaNotaCreditoIvaEntrata, AggiornaNotaCreditoIvaEntrataResponse> {
...
//		checkCondition(subdocIva.getSubdocumentoIvaPadre().getUid()!=0,  ErroreCore.PARAMETRO_NON_INIZIALIZZATO.getErrore("uid subdocumento iva padre"), false);
	...
	@Transactional
	@Override
	public AggiornaNotaCreditoIvaEntrataResponse executeService(AggiornaNotaCreditoIvaEntrata serviceRequest) {
