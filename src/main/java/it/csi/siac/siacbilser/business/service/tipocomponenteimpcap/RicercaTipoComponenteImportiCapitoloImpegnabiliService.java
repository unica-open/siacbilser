...
public class RicercaTipoComponenteImportiCapitoloImpegnabiliService extends BaseTipoComponenteImportiCapitoloService<RicercaTipoComponenteImportiCapitolo, RicercaTipoComponenteImportiCapitoloResponse> {
	...
	protected void execute() {
		...
		List<TipoComponenteImportiCapitolo> listaTipoCompImp = tipoComponenteImportiCapitoloDad.findAllByEnteProprietarioIdImpegnabili( req.getTipoComponenteImportiCapitolo());
