...
/**
 * The Class RicercaDettaglioCausaleSpesaService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class RicercaDettaglioCausaleSpesaService extends CheckedAccountBaseService<RicercaDettaglioCausaleSpesa, RicercaDettaglioCausaleSpesaResponse> {
	...
	@Override
	@Transactional
	public RicercaDettaglioCausaleSpesaResponse executeService(RicercaDettaglioCausaleSpesa serviceRequest) {
	...
	protected void execute() {
		CausaleSpesa preDocumentoSpesa = causaleDad.findCausaleSpesaById(causale.getUid());
		if(preDocumentoSpesa==null) {
			res.addErrore(ErroreCore.ENTITA_NON_TROVATA.getErrore("CausaleSpesa","uid: "+ causale.getUid()));
			res.setEsito(Esito.FALLIMENTO);
			return;
		}
		res.setCausaleSpesa(preDocumentoSpesa);	
	}
