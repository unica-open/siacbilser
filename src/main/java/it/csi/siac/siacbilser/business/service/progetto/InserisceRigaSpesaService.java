...
/**
 * The Class InserisceRigaSpesaService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class InserisceRigaSpesaService extends CheckedAccountBaseService<InserisceRigaSpesa, InserisceRigaSpesaResponse> {
	 ...
	 */
	public void checkServiceParam(InserisceRigaSpesa req) throws ServiceParamError {
		this.req = req;
	...
	protected void checkServiceParam() throws ServiceParamError {
		...
		//checkNotNull(dett.getNumeroCapitolo(), ErroreCore.PARAMETRO_NON_INIZIALIZZATO.getErrore("numero capitolo")); //NON OBBLIGATORIO
...
//		checkNotNull(dett.getMissione(), ErroreCore.PARAMETRO_NON_INIZIALIZZATO.getErrore("missione")); //Determinato dal Programma
	...
	@Override
	@Transactional
	public InserisceRigaSpesaResponse executeService(InserisceRigaSpesa serviceRequest) {
	...
	protected void execute() {
		...
		cronoprogrammaDad.inserisciDettaglioUscitaCronoprogramma(dett, tipoCapitoloDettaglio);
