 ...
 */
public class TxRequiresNewTimeoutBaseServiceInvoker<REQ extends ServiceRequest, RES extends ServiceResponse> implements ServiceInvoker<REQ, RES> {
	 ...
	 */
	public TxRequiresNewTimeoutBaseServiceInvoker(ExtendedBaseService<REQ, RES> service) {
		this.service = service;
	}

	@Override
	public RES invokeService(REQ req) {
		return service.executeServiceTxRequiresNewWithTimeout(req);
	}
