...
public class InserisceAccantonamentoFondiDubbiaEsigibilitaImportRendicontoService extends BaseAccantonamentoFondiDubbiaEsigibilitaImportRendicontoService<InserisceAccantonamentoFondiDubbiaEsigibilitaImportRendiconto, InserisceAccantonamentoFondiDubbiaEsigibilitaImportRendicontoResponse> {
	
	@Override
	@Transactional
	public InserisceAccantonamentoFondiDubbiaEsigibilitaImportRendicontoResponse executeService(InserisceAccantonamentoFondiDubbiaEsigibilitaImportRendiconto serviceRequest) {
		//eseguo il servizio
	...
	protected void execute() {
		...
		for(AccantonamentoFondiDubbiaEsigibilitaRendiconto afde : fondiDubbiaEsigibilita) {
			// Popolamento dati
