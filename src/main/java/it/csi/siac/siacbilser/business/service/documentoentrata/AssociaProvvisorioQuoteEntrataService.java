...
/**
 * Aggiorna le quote di entrata associando il provvisorio
 *
 * @author Valentina
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class AssociaProvvisorioQuoteEntrataService extends CrudDocumentoDiEntrataBaseService<AssociaProvvisorioQuoteEntrata, AssociaProvvisorioQuoteEntrataResponse> {
	...
	protected void checkServiceParam() throws ServiceParamError {
		...
		for(SubdocumentoEntrata subdoc : req.getListaQuote()){
			checkEntita(subdoc, "subdocumento di entrata");
		}
	...
	@Override
	@Transactional
	public AssociaProvvisorioQuoteEntrataResponse executeService(AssociaProvvisorioQuoteEntrata serviceRequest) {
	...
	private void checkImportoDaRegolarizzare() {
		...
		// SIAC-6077: restituisco l'importo da regolarizzare 'aggiornato' al front-end
