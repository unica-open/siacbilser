...
/**
 * The Class LeggiTipiCausaleEntrataService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class LeggiTipiCausaleEntrataService extends CheckedAccountBaseService<LeggiTipiCausaleEntrata, LeggiTipiCausaleEntrataResponse> {
	...
	@Override
	@Transactional
	public LeggiTipiCausaleEntrataResponse executeService(LeggiTipiCausaleEntrata serviceRequest) {
	...
	protected void execute() {
		List<TipoCausale> listatipoCausale = tipiCausaleDad.ricercaTipiCausaleEntrataByEnte(req.getEnte());
