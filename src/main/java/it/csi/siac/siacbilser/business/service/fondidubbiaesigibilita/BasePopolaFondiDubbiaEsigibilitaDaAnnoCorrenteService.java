...
import it.csi.siac.siacbilser.frontend.webservice.msg.BasePopolaFondiDubbiaEsigibilita;
import it.csi.siac.siacbilser.frontend.webservice.msg.BasePopolaFondiDubbiaEsigibilitaResponse;
 ...
 */
public abstract class BasePopolaFondiDubbiaEsigibilitaDaAnnoCorrenteService<
		//capitolo
		C extends Capitolo<?, ?>,
		...
		REQ extends BasePopolaFondiDubbiaEsigibilita,
		//response per il servizio di popolamento
		RES extends BasePopolaFondiDubbiaEsigibilitaResponse<A>> extends CheckedAccountBaseService<REQ, RES> {
	...
	protected Bilancio ottieniBilancioPrecedente() {
		final String methodName = "ottieniBilancioPrecedente";
		//carico il bilancio
	...
	private void popolaNuovoAccantonamento(AO afdePrecedente, Integer uid) {
		...
		//cerco eventuali accantonamenti presenti precedentemente
