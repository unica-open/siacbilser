...
/**
 * The Class InserisceStornoUEBEntrataService.
 */
@Service

@Scope(BeanDefinition.SCOPE_PROTOTYPE)
@Deprecated
public class InserisceStornoUEBEntrataService extends InserisceStornoUEBBaseService {
...
//			checkVariazioneImporti(dettVarImp, importiCapitolo);
//			
//		}
	}
	 ...
	 */
	private void checkVariazioneImporti(DettaglioVariazioneImportoCapitolo dettVarImp, ImportiCapitolo importiCapitolo/*, BigDecimal disponibilitaVariare*/) {
		// SIAC-6883
//		
...
//		
//		
//		Integer annoCompetenzaVariazione = dettVarImp.getAnnoCompetenza();
//		Integer annoCompetenzaCapitolo = importiCapitolo.getAnnoCompetenza();
//		Integer delta = annoCompetenzaVariazione - annoCompetenzaCapitolo + 1;
//		
