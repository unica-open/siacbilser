...
public class AnnullaCausaleService extends CheckedAccountBaseService<AnnullaCausale, AnnullaCausaleResponse> {
	...
	@Transactional
	@Override
	public AnnullaCausaleResponse executeService(AnnullaCausale serviceRequest) {
	...
	protected void execute() {
		...
		causaleEPDad.aggiornaStatoOperativoCausaleEP(causaleEP, StatoOperativoCausaleEP.ANNULLATO);
	...
	private void checkStatoOperativo() {
		if(causaleEP.getStatoOperativoCausaleEP() != StatoOperativoCausaleEP.VALIDO) {
