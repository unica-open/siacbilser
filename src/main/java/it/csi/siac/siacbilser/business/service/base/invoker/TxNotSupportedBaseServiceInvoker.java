 ...
 */
public class TxNotSupportedBaseServiceInvoker<REQ extends ServiceRequest, RES extends ServiceResponse> implements ServiceInvoker<REQ, RES> {
	 ...
	 */
	public TxNotSupportedBaseServiceInvoker(ExtendedBaseService<REQ, RES> service) {
		this.service = service;
	}

	@Override
	public RES invokeService(REQ req) {
		return service.executeServiceTxNotSupported(req);
	}
