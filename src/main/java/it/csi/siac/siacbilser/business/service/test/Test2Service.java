...
public class Test2Service extends ExtendedBaseService<UploadFile, UploadFileResponse> {
...
//	private SiacDCausaleTipoRepository siacDCausaleTipoRepository;
	...
	protected void execute() {
		...
		//SiacDCausaleTipo c2 = siacDCausaleTipoRepository.findOne(1);
		SiacDCausaleTipo c2 = entityManager.find(SiacDCausaleTipo.class, 1);
		log.info(methodName, "Accesso in lettura dopo Test1Commit: uid: "+ c2.getUid()+ " code:" + c2.getCausTipoCode() + " desc: "+c2.getCausTipoDesc());
