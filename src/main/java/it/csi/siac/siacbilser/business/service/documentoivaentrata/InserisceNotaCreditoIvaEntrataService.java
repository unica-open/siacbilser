...
public class InserisceNotaCreditoIvaEntrataService extends CrudSubdocumentoIvaEntrataBaseService<InserisceNotaCreditoIvaEntrata, InserisceNotaCreditoIvaEntrataResponse>{
	...
	@Transactional
	@Override
	public InserisceNotaCreditoIvaEntrataResponse executeService(InserisceNotaCreditoIvaEntrata serviceRequest) {
