...
public class SimulaInserisceAccantonamentoFondiDubbiaEsigibilitaImportRendicontoService extends BaseAccantonamentoFondiDubbiaEsigibilitaImportRendicontoService<SimulaInserisceAccantonamentoFondiDubbiaEsigibilitaImportRendiconto, SimulaInserisceAccantonamentoFondiDubbiaEsigibilitaImportRendicontoResponse> {
	
	@Override
	@Transactional(readOnly = true)
	public SimulaInserisceAccantonamentoFondiDubbiaEsigibilitaImportRendicontoResponse executeService(SimulaInserisceAccantonamentoFondiDubbiaEsigibilitaImportRendiconto serviceRequest) {
		//eseguo il servizio
