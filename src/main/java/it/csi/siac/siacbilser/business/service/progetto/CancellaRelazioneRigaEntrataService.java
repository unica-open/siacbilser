...
/**
 * The Class CancellaRelazioneRigaEntrataService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class CancellaRelazioneRigaEntrataService extends CheckedAccountBaseService<CancellaRelazioneRigaEntrata, CancellaRelazioneRigaEntrataResponse> {
	...
	@Override
	@Transactional
	public CancellaRelazioneRigaEntrataResponse executeService(CancellaRelazioneRigaEntrata serviceRequest) {
	...
	protected void execute() {
		cronoprogrammaDad.cancellaRelazioneDettaglioEntrataCronoprogramma(dett);
