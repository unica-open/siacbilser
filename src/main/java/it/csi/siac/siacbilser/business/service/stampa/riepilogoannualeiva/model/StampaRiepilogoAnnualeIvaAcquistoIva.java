...
public class StampaRiepilogoAnnualeIvaAcquistoIva {
	
	private AliquotaIva aliquotaIva; //A1, B1, C1, D1, E1

	// - Per ogni codice aliquota (ogni riga della tabella) si selezionano
	// dall’entità "Progressivi Iva" tutti i registri del gruppo selezionato di
	// tipo TipoRegistroIva.
	// - Dall’elenco così ottenuto si fa la somma dei valori del campo
	// "totImponibileDef" o “totImponibileProvv”
	private BigDecimal imponibile; //F1

	// - Per ogni codice aliquota (ogni riga della tabella) si selezionano
	// dall’entità "Progressivi Iva" tutti i registri del gruppo selezionato e
	// di tipo TipoRegistroIva.
	// - Dall’elenco così ottenuto si fa la somma dei valori del campo
	// "totIvaDef"
