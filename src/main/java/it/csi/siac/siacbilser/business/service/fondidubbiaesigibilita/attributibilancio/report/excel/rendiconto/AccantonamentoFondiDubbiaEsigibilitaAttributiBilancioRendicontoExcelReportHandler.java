...
public class AccantonamentoFondiDubbiaEsigibilitaAttributiBilancioRendicontoExcelReportHandler 
	...
	protected ExcelSheet<? extends BaseExcelRow>[] instantiateExcelSheets() {
		List<Object[]> dettagli = accantonamentoFondiDubbiaEsigibilitaRendicontoDad.findDettagliAccantonamentoByUidAttributiBilancio(accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.getUid());
		...
		return ArrayUtil.toArray(
				new IntestazioneAccantonamentoFondiDubbiaEsigibilitaExcelSheet(dettaglio0[0], dettaglio0[1],
						dettaglio0[2], dettaglio0[3], dettaglio0[4], dettaglio0[5], dettaglio0[6], dettaglio0[33]),
				new AccantonamentoFondiDubbiaEsigibilitaAttributiBilancioRendicontoExcelSheet(
