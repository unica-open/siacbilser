...
public class RiCompletaAllegatoAttoPerElenchiAsyncResponseHandler extends BilAsyncResponseHandler<RiCompletaAllegatoAttoPerElenchiResponse> {

	@Override
	public void handleResponse(RiCompletaAllegatoAttoPerElenchiResponse response) {
