...
public class AggiornaConciliazionePerBeneficiarioService extends CheckedAccountBaseService<AggiornaConciliazionePerBeneficiario, AggiornaConciliazionePerBeneficiarioResponse> {
	...
	@Override
	@Transactional
	public AggiornaConciliazionePerBeneficiarioResponse executeService(AggiornaConciliazionePerBeneficiario serviceRequest) {
	...
	protected void execute() {
		...
		// 5. Aggiornamento
		conciliazioneDad.aggiornaConciliazionePerBeneficiario(conciliazionePerBeneficiario);
	...
	private void checkNonGiaCollegato() {
		...
		Long count = conciliazioneDad.countConciliazioniBeneficiarioByContoAndCapitoloAndSoggetto(conciliazionePerBeneficiario.getConto(), conciliazionePerBeneficiario.getCapitolo(),
				conciliazionePerBeneficiario.getSoggetto(), conciliazionePerBeneficiario.getUid());
