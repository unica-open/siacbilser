...
public class InserisceNotaCreditoIvaSpesaService extends CrudSubdocumentoIvaSpesaBaseService<InserisceNotaCreditoIvaSpesa, InserisceNotaCreditoIvaSpesaResponse>{
	...
	@Transactional
	@Override
	public InserisceNotaCreditoIvaSpesaResponse executeService(InserisceNotaCreditoIvaSpesa serviceRequest) {
