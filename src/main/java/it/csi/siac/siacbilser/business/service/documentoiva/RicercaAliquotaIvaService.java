...
/**
 * The Class RicercaAliquotaIvaService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class RicercaAliquotaIvaService extends CheckedAccountBaseService<RicercaAliquotaIva, RicercaAliquotaIvaResponse> {
	...
	@Override
	public RicercaAliquotaIvaResponse executeService(RicercaAliquotaIva serviceRequest) {
	...
	protected void execute() {
		List<AliquotaIva> listaAliquotaIva = documentoIvaDad.ricercaAliquotaIva();
		res.setListaAliquotaIva(listaAliquotaIva);
		res.setCardinalitaComplessiva(listaAliquotaIva.size());
	}
