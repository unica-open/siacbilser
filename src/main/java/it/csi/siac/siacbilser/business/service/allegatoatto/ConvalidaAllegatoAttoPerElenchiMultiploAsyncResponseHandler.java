...
/**
 * The Class ConvalidaAllegatoAttoPerElenchiMultiploAsyncResponseHandler.
 */
@Component
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class ConvalidaAllegatoAttoPerElenchiMultiploAsyncResponseHandler extends BilAsyncResponseHandler<ConvalidaAllegatoAttoPerElenchiMultiploResponse> {

	@Override
	public void handleResponse(ConvalidaAllegatoAttoPerElenchiMultiploResponse response) {
