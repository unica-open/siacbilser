...
public class CalcoloFondoPluriennaleVincolatoEntrataService extends CheckedAccountBaseService<CalcoloFondoPluriennaleVincolatoEntrata, CalcoloFondoPluriennaleVincolatoEntrataResponse> {
	...
	public CalcoloFondoPluriennaleVincolatoEntrataResponse executeService(CalcoloFondoPluriennaleVincolatoEntrata serviceRequest) {
	...
	protected void execute() {
		List<FondoPluriennaleVincolatoEntrata> listaFondoPluriennaleVincolatoEntrata = progettoDad.calcoloFpvEntrata(req.getProgetto(), req.getAnno());
