...
/**
 * The Class AggiornaProrataEChiusuraGruppoIvaService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class AggiornaProrataEChiusuraGruppoIvaService extends CheckedAccountBaseService<AggiornaProrataEChiusuraGruppoIva, AggiornaProrataEChiusuraGruppoIvaResponse> {

	/** The prorata e chiusura gruppo iva dad. */
	@Autowired
	protected ProrataEChiusuraGruppoIvaDad prorataEChiusuraGruppoIvaDad;
	...
	@Transactional
	@Override
	public AggiornaProrataEChiusuraGruppoIvaResponse executeService(AggiornaProrataEChiusuraGruppoIva serviceRequest) {
	...
	protected void execute() {
		prorataEChiusuraGruppoIvaDad.aggiornaProrataEChiusuraGruppoIva(prorata);
