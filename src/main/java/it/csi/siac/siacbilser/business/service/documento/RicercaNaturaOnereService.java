...
/**
 * The Class RicercaNaturaOnereService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class RicercaNaturaOnereService extends CheckedAccountBaseService<RicercaNaturaOnere, RicercaNaturaOnereResponse>{
	
	/** The natura onere dad. */
	@Autowired
	...
	@Transactional
	@Override
	public RicercaNaturaOnereResponse executeService(RicercaNaturaOnere serviceRequest) {
	...
	protected void execute() {
		res.setElencoNatureOnere(naturaOnereDad.ricercaNatureOnere(req.getEnte()));
