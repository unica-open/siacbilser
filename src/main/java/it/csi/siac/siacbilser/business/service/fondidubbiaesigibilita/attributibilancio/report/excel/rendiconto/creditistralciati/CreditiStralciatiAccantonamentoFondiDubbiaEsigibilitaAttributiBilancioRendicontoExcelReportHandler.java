...
public class CreditiStralciatiAccantonamentoFondiDubbiaEsigibilitaAttributiBilancioRendicontoExcelReportHandler
	...
	protected ExcelSheet<? extends BaseExcelRow>[] instantiateExcelSheets() {
		List<Object[]> dettagli = accantonamentoFondiDubbiaEsigibilitaRendicontoDad.findDettagliCreditiStralciatiByUidAttributiBilancio(accantonamentoFondiDubbiaEsigibilitaAttributiBilancio.getUid());
		...
		return ArrayUtil.toArray(
			...
			new CreditiStralciatiAccantonamentoFondiDubbiaEsigibilitaAttributiBilancioRendicontoExcelSheet(dettagli));
	}
}
