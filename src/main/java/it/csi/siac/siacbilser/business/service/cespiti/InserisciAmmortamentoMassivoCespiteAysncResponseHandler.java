...
public class InserisciAmmortamentoMassivoCespiteAysncResponseHandler extends BilAsyncResponseHandler<InserisciAmmortamentoMassivoCespiteResponse> {

	@Override
	public void handleResponse(InserisciAmmortamentoMassivoCespiteResponse response) {
