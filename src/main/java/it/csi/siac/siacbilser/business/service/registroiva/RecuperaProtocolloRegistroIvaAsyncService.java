...
/**
 * Wrapper async di {@link RecuperaProtocolloRegistroIvaAsyncService}.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class RecuperaProtocolloRegistroIvaAsyncService extends AsyncBaseService<RecuperaProtocolloRegistroIva, RecuperaProtocolloRegistroIvaResponse,
		AsyncServiceRequestWrapper<RecuperaProtocolloRegistroIva>, RecuperaProtocolloRegistroIvaAsyncResponseHandler, RecuperaProtocolloRegistroIvaService> {
	...
	protected void startService() {
		...
		try {
			elaborazioniManager.startElaborazione(RecuperaProtocolloRegistroIvaAsyncService.class, "registroIva.uid:"+originalRequest.getRegistroIva().getUid());
