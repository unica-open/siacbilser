...
public class ConvalidaAllegatoAttoPerElenchiAsyncResponseHandler extends BilAsyncResponseHandler<ConvalidaAllegatoAttoPerElenchiResponse> {

	@Override
	public void handleResponse(ConvalidaAllegatoAttoPerElenchiResponse response) {
