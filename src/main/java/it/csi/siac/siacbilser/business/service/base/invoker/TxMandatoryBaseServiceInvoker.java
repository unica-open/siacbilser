 ...
 */
public class TxMandatoryBaseServiceInvoker<REQ extends ServiceRequest, RES extends ServiceResponse> implements ServiceInvoker<REQ, RES> {
	 ...
	 */
	public TxMandatoryBaseServiceInvoker(ExtendedBaseService<REQ, RES> service) {
		this.service = service;
	}

	@Override
	public RES invokeService(REQ req) {
		return service.executeServiceTxMandatory(req);
	}
