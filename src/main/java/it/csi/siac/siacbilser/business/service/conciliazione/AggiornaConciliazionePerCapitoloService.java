...
public class AggiornaConciliazionePerCapitoloService extends CheckedAccountBaseService<AggiornaConciliazionePerCapitolo, AggiornaConciliazionePerCapitoloResponse> {
	...
	@Override
	@Transactional
	public AggiornaConciliazionePerCapitoloResponse executeService(AggiornaConciliazionePerCapitolo serviceRequest) {
...
//		checkNonGiaCollegato();
		// 4. Inserimento
		conciliazioneDad.aggiornaConciliazionePerCapitolo(conciliazionePerCapitolo);
	...
	private void checkNonGiaCollegato() {
		...
		Long count = conciliazioneDad.countConciliazioniCapitoloByContoAndCapitolo(conciliazionePerCapitolo.getConto(), conciliazionePerCapitolo.getCapitolo(), conciliazionePerCapitolo.getUid());
		log.debug(methodName, "Numero conciliazioni per conto [" + conciliazionePerCapitolo.getConto().getUid() + "], capitolo [" + conciliazionePerCapitolo.getCapitolo().getUid()
				+ "] distinte da quella da aggiornare [" + conciliazionePerCapitolo.getUid() + "]: " + count);
