...
public class RicercaSinteticaTipoGiustificativoService extends CheckedAccountBaseService<RicercaSinteticaTipoGiustificativo, RicercaSinteticaTipoGiustificativoResponse> {
	...
	@Override
	@Transactional
	public RicercaSinteticaTipoGiustificativoResponse executeService(RicercaSinteticaTipoGiustificativo serviceRequest) {
	...
	protected void execute() {
		 ListaPaginata<TipoGiustificativo> tipiGiustificativo = tipoGiustificativoDad.ricercaSinteticaTipoGiustificativo(tipoGiustificativo, req.getParametriPaginazione());
		 if(tipiGiustificativo == null || tipiGiustificativo.isEmpty()){
			 res.setEsito(Esito.FALLIMENTO);
			 res.addErrore(ErroreCore.NESSUN_DATO_REPERITO.getErrore());
		 }
		 res.setTipiGiustificativo(tipiGiustificativo);
	}
