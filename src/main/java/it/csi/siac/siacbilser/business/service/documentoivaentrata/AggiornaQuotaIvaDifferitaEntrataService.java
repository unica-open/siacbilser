...
public class AggiornaQuotaIvaDifferitaEntrataService extends CrudSubdocumentoIvaEntrataBaseService<AggiornaQuotaIvaDifferitaEntrata, AggiornaQuotaIvaDifferitaEntrataResponse> {
	...
	@Transactional
	@Override
	public AggiornaQuotaIvaDifferitaEntrataResponse executeService(AggiornaQuotaIvaDifferitaEntrata serviceRequest) {
