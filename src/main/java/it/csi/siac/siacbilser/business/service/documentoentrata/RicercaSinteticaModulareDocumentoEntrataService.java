...
public class RicercaSinteticaModulareDocumentoEntrataService extends
		ExtendedBaseService<RicercaSinteticaModulareDocumentoEntrata, RicercaSinteticaModulareDocumentoEntrataResponse> {
	...
	public RicercaSinteticaModulareDocumentoEntrataResponse executeService(RicercaSinteticaModulareDocumentoEntrata serviceRequest) {
	...
	protected void execute() {
		...
		ListaPaginata<DocumentoEntrata> listaDocumentoEntrata = documentoEntrataDad.ricercaSinteticaDocumentoEntrata(doc, 
