...
/**
 * The Class InserisceCausaleSpesaService.
 */
@Service
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class InserisceCausaleSpesaService extends CrudCausaleDiSpesaBaseService<InserisceCausaleSpesa, InserisceCausaleSpesaResponse> {
	...
	@Override
	@Transactional
	public InserisceCausaleSpesaResponse executeService(InserisceCausaleSpesa serviceRequest) {
	...
	protected void execute() {
		...
		causaleDad.inserisciCausaleSpesa(causale);
