...
public class RicercaSinteticaModulareCausaleService extends CheckedAccountBaseService<RicercaSinteticaModulareCausale, RicercaSinteticaModulareCausaleResponse> {
	...
	public RicercaSinteticaModulareCausaleResponse executeService(RicercaSinteticaModulareCausale serviceRequest) {
	...
	protected void execute() {
		...
		ListaPaginata<CausaleEP> causaliEP = causaleEPDad.ricercaSinteticaCausaleEP(req.getCausaleEP(), req.getTipoEvento(), req.getParametriPaginazione(), req.getCausaleEPModelDetails());
