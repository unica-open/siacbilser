 ...
 */
public class TxRequiresNewBaseServiceInvoker<REQ extends ServiceRequest, RES extends ServiceResponse> implements ServiceInvoker<REQ, RES> {
	 ...
	 */
	public TxRequiresNewBaseServiceInvoker(ExtendedBaseService<REQ, RES> service) {
