 ...
 */
@Component
public class ModificaMovimentoGestioneEntrataAccertamentoDatiFinanziariConverter extends ModificaMovimentoGestioneMovimentoGestioneDatiFinanziariConverter<Accertamento, SubAccertamento, ModificaMovimentoGestioneEntrata> {

	/**
	 * Instantiates a new modifica movimento gestione entrata - impegno converter.
	 */
	public ModificaMovimentoGestioneEntrataAccertamentoDatiFinanziariConverter() {
