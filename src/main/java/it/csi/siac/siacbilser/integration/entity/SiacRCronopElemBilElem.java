...
@NamedQuery(name="SiacRCronopElemBilElem.findAll", query="SELECT s FROM SiacRCronopElemBilElem s")
public class SiacRCronopElemBilElem extends SiacTEnteBase {
