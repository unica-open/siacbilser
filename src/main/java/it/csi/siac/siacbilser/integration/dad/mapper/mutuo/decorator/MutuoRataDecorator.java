...
public class MutuoRataDecorator extends BaseMapperDecorator<SiacTMutuo, Mutuo> {
	...
	public void decorate(SiacTMutuo s, Mutuo d) {
		d.setElencoRate(siacTMutuoRataRataMutuoMapper.map(siacTMutuoHelper.getSiacTMutuoRataSortedList(s)));
	}
}
