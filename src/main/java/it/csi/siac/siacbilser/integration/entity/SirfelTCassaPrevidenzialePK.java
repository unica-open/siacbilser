...
/**
 * The primary key class for the sirfel_t_cassa_previdenziale database table.
 * 
 */
@Embeddable
public class SirfelTCassaPrevidenzialePK extends SirfelPKBase {
...
//	private Integer enteProprietarioId;
	...
	public SirfelTCassaPrevidenzialePK() {
	}
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelTCassaPrevidenzialePK)) {
			return false;
		}
		SirfelTCassaPrevidenzialePK castOther = (SirfelTCassaPrevidenzialePK)other;
		return 
