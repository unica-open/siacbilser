 ...
 */
@Component
public class DettaglioAnteprimaAmmortamentoAnnuoCespiteAnteprimaConverter extends ExtendedDozerConverter<DettaglioAnteprimaAmmortamentoAnnuoCespite, SiacTCespitiElabAmmortamentiDett> {
	

	/**
	 * Instantiates a new subdocumento Entrata subdocumento iva converter.
	 */
	public DettaglioAnteprimaAmmortamentoAnnuoCespiteAnteprimaConverter() {
	...
	public DettaglioAnteprimaAmmortamentoAnnuoCespite convertFrom(SiacTCespitiElabAmmortamentiDett src, DettaglioAnteprimaAmmortamentoAnnuoCespite dest) {
		dest.setAnteprimaAmmortamentoAnnuoCespite(mapNotNull(src.getSiacTCespitiElabAmmortamenti(), AnteprimaAmmortamentoAnnuoCespite.class, CespMapId.SiacTCespitiElabAmmortamenti_AnteprimaAmmortamentoAnnuoCespite_ModelDetail));
		return dest;
	}
