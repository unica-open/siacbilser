...
public class ImpegnoCapitoloDecorator extends BaseMapperDecorator<SiacTMovgest, Impegno> {

	@Autowired private SiacTBilElemCapitoloUscitaGestioneMapper siacTBilElemCapitoloUscitaGestioneMapper;
	@Autowired private SiacTMovgestHelper siacTMovgestHelper;
	
	@Override
	public void decorate(SiacTMovgest s, Impegno d) {
		d.setCapitoloUscitaGestione(siacTBilElemCapitoloUscitaGestioneMapper.map(siacTMovgestHelper.getSiacTBilElem(s)
				, (MapperDecorator<SiacTBilElem, CapitoloUscitaGestione>[]) getMapperDecorators()));
	}
}
