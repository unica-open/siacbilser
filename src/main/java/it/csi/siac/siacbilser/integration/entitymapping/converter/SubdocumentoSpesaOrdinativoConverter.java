...
/**
 * The Class SubdocumentoSpesaOrdinativoConverter.
 */
@Component
public class SubdocumentoSpesaOrdinativoConverter extends ExtendedDozerConverter<SubdocumentoSpesa, SiacTSubdoc > {
	 ...
	 */
	public SubdocumentoSpesaOrdinativoConverter() {
