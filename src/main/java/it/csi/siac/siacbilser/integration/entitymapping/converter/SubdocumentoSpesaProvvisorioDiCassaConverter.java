 ...
 */
@Component
public class SubdocumentoSpesaProvvisorioDiCassaConverter extends ExtendedDozerConverter<SubdocumentoSpesa, SiacTSubdoc > {

	/**
	 * Instantiates a new subdocumento spesa subdocumento iva converter.
	 */
	public SubdocumentoSpesaProvvisorioDiCassaConverter() {
