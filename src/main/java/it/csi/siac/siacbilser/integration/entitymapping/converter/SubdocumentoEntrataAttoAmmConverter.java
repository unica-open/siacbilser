...
/**
 * The Class SubdocumentoEntrataAttoAmmConverter.
 */
@Component
public class SubdocumentoEntrataAttoAmmConverter extends ExtendedDozerConverter<SubdocumentoEntrata, SiacTSubdoc> {
	...
	/**
	 * Instantiates a new subdocumento entrata atto amm converter.
	 */
	public SubdocumentoEntrataAttoAmmConverter() {
