 ...
 */
@Component
public class CapitoloUscitaPrevisioneAttrConverter extends BaseAttrConverter<CapitoloUscitaPrevisione, SiacTBilElem, SiacRBilElemAttr> {
	
	/**
	 * Instantiates a new attributi bilancio attr converter.
	 */
	public CapitoloUscitaPrevisioneAttrConverter() {
