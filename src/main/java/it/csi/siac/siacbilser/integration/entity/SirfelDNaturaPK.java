...
/**
 * The primary key class for the sirfel_d_natura database table.
 * 
 */
@Embeddable
public class SirfelDNaturaPK extends SirfelPKBase {
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelDNaturaPK)) {
			return false;
		}
		SirfelDNaturaPK castOther = (SirfelDNaturaPK)other;
		return 
