...
@NamedQuery(name="SiacRSubdocOrdinativoT.findAll", query="SELECT s FROM SiacRSubdocOrdinativoT s")
public class SiacRSubdocOrdinativoT extends SiacTEnteBase {
