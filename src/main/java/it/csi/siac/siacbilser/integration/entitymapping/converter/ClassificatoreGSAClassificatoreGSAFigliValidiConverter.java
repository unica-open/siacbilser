 ...
 */
@Component
public class ClassificatoreGSAClassificatoreGSAFigliValidiConverter extends ExtendedDozerConverter<ClassificatoreGSA, SiacTGsaClassif > {
	
	@Autowired private SiacTGsaClassifRepository siacTGsaClassifRepository;

	/** Costruttore vuoto di default */
	public ClassificatoreGSAClassificatoreGSAFigliValidiConverter() {
	...
	public ClassificatoreGSA convertFrom(SiacTGsaClassif src, ClassificatoreGSA dest) {
		...
		List<SiacTGsaClassif> gsaClassifFigli = siacTGsaClassifRepository.findSiacTGsaClassifFigliByIdPadreAndGsaClassifStatoCode(src.getUid(), SiacDGsaClassifStatoEnum.VALIDO.getCodice());
