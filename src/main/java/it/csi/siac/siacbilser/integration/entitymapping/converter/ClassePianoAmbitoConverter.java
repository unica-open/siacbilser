...
@Component
public class ClassePianoAmbitoConverter extends ExtendedDozerConverter<ClassePiano, SiacDPdceFam > {
	
	@Autowired
	private EnumEntityFactory eef;
	

	public ClassePianoAmbitoConverter() {
		super(ClassePiano.class, SiacDPdceFam.class);
	}

	@Override
	public ClassePiano convertFrom(SiacDPdceFam src, ClassePiano dest) {
	...
	@Override
	public SiacDPdceFam convertTo(ClassePiano src, SiacDPdceFam dest) {
