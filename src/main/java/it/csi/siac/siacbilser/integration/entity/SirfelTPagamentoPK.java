...
/**
 * The primary key class for the sirfel_t_pagamento database table.
 * 
 */
@Embeddable
public class SirfelTPagamentoPK extends SirfelPKBase {
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelTPagamentoPK)) {
			return false;
		}
		SirfelTPagamentoPK castOther = (SirfelTPagamentoPK)other;
		return 
