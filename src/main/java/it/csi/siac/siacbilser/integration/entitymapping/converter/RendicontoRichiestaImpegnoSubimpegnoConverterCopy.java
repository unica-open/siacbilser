...
//	private EnumEntityFactory eef;
	 ...
	 */
	public RendicontoRichiestaImpegnoSubimpegnoConverterCopy() {
	...
	public RendicontoRichiesta convertFrom(SiacTGiustificativo src, RendicontoRichiesta dest) {
		...
		if(src.getSiacRGiustificativoMovgests()!=null){
			for(SiacRGiustificativoMovgest siacRSubdocMovgestT : src.getSiacRGiustificativoMovgests()){
				//log.debug(methodName, "SiacTGiustificativo: id = " + src.getSubdocId());
				log.debug(methodName, "SiacRGiustificativoMovgest: id = " + siacRSubdocMovgestT.getUid());
	...
	public SiacTGiustificativo convertTo(RendicontoRichiesta src, SiacTGiustificativo dest) {
		...
		SiacRGiustificativoMovgest siacRSubdocMovgestT = new SiacRGiustificativoMovgest();
		siacRSubdocMovgestT.setSiacTGiustificativo(dest);
		...
		dest.addSiacRGiustificativoMovgest(siacRSubdocMovgestT);
