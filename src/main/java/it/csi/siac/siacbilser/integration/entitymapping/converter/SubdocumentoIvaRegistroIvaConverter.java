 ...
 */
@Component
public class SubdocumentoIvaRegistroIvaConverter extends ExtendedDozerConverter<SubdocumentoIva<?, ?, ?>, SiacTSubdocIva > {
	
	/**
	 * Instantiates a new subdocumento iva registro iva converter.
	 */
	@SuppressWarnings("unchecked")
	public SubdocumentoIvaRegistroIvaConverter() {
	...
	public SubdocumentoIva<?, ?, ?> convertFrom(SiacTSubdocIva siacTSubdocIva, SubdocumentoIva<?, ?, ?> dest) {
		...
		RegistroIva registroIva = map(siacTIvaRegistro, RegistroIva.class, BilMapId.SiacTIvaRegistro_RegistroIva);
