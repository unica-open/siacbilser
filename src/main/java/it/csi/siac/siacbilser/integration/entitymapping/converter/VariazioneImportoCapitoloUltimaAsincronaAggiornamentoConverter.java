 ...
 */
@Component
public class VariazioneImportoCapitoloUltimaAsincronaAggiornamentoConverter extends ExtendedDozerConverter<VariazioneImportoCapitolo, SiacTVariazione> {
	 ...
	 */
	public VariazioneImportoCapitoloUltimaAsincronaAggiornamentoConverter() {
	...
	public VariazioneImportoCapitolo convertFrom(SiacTVariazione src, VariazioneImportoCapitolo dest) {
		...
		Page<SiacTOperazioneAsincrona> siacTOperazioneAsincronasPage = siacTOperazioneAsincronaRepository.ottieniLaPiuRecenteOperazioneAsincronaByAzioneEUidVariazione(uidVariazione, AzioneConsentitaEnum.AGGIORNA_VARIAZIONE.getNomeAzione(), Arrays.asList("ELABORAZIONE_CONCORRENTE"), enteProprietarioId, pageable);
		...
		dest.setUltimaAsincronaAggiornamento(mapNotNull(siacTOperazioneAsincronas.get(0), OperazioneAsincrona.class, CorMapId.SiacTOperazioneAsincrona_OperazioneAsincrona_Bil));
		return dest;
	}
