...
public class SiacRBilElemAttr extends SiacTEnteBase implements SiacRAttrBase<SiacTBilElem> {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** The bil elem attr id. */
	@Id
	@SequenceGenerator(name="SIAC_R_BIL_ELEM_ATTR_BILELEMATTRID_GENERATOR", allocationSize=1, sequenceName="SIAC_R_BIL_ELEM_ATTR_BIL_ELEM_ATTR_ID_SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SIAC_R_BIL_ELEM_ATTR_BILELEMATTRID_GENERATOR")
	...
	/**
	 * Instantiates a new siac r bil elem attr.
	 */
	public SiacRBilElemAttr() {
	}

	/**
	 * Gets the bil elem attr id.
	 *
	 * @return the bil elem attr id
	 */
	...
	/**
	 * Sets the bil elem attr id.
	 *
	 * @param bilElemAttrId the new bil elem attr id
	 */
	...
	@Override
	public void setEntity(SiacTBilElem entity) {
		setSiacTBilElem(entity);
	}
