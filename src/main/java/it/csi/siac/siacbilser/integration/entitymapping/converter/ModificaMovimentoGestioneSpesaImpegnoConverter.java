 ...
 */
@Component
public class ModificaMovimentoGestioneSpesaImpegnoConverter extends ModificaMovimentoGestioneMovimentoGestioneConverter<Impegno, SubImpegno, ModificaMovimentoGestioneSpesa> {

	/**
	 * Instantiates a new modifica movimento gestione spesa - impegno converter.
	 */
	public ModificaMovimentoGestioneSpesaImpegnoConverter() {
