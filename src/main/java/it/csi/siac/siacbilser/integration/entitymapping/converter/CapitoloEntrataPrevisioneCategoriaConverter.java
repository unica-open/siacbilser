 ...
 */
@Component
public class CapitoloEntrataPrevisioneCategoriaConverter extends ExtendedDozerConverter<CapitoloEntrataPrevisione, SiacTBilElem > {

	/**
	 * Instantiates a CapitoloEntrataPrevisioneCategoriaConverter.
	 */
	public CapitoloEntrataPrevisioneCategoriaConverter() {
