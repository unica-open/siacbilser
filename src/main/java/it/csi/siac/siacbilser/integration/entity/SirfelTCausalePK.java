...
/**
 * The primary key class for the sirfel_t_causale database table.
 * 
 */
@Embeddable
public class SirfelTCausalePK extends SirfelPKBase {
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelTCausalePK)) {
			return false;
		}
		SirfelTCausalePK castOther = (SirfelTCausalePK)other;
		return 
