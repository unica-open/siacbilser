...
@NamedQuery(name="SiacROnereAttr.findAll", query="SELECT s FROM SiacROnereAttr s")
public class SiacROnereAttr extends SiacTEnteBase {
	...
	/** The onere attr id. */
	@Id
	@SequenceGenerator(name="SIAC_R_ONERE_ATTR_ONEREATTRID_GENERATOR", allocationSize=1, sequenceName="SIAC_R_ONERE_ATTR_ONERE_ATTR_ID_SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SIAC_R_ONERE_ATTR_ONEREATTRID_GENERATOR")
	...
	/**
	 * Instantiates a new siac r onere attr.
	 */
	public SiacROnereAttr() {
	}

	/**
	 * Gets the onere attr id.
	 *
	 * @return the onere attr id
	 */
	...
	/**
	 * Sets the onere attr id.
	 *
	 * @param onereAttrId the new onere attr id
	 */
