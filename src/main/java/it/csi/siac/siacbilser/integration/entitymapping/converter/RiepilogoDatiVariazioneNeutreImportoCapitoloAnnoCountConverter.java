 ...
 */
@Component
public class RiepilogoDatiVariazioneNeutreImportoCapitoloAnnoCountConverter extends DozerConverter<RiepilogoDatiVariazioneImportoCapitoloAnno, List<Object[]>> {
	...
	public RiepilogoDatiVariazioneNeutreImportoCapitoloAnnoCountConverter() {
	...
	private void convertArray(Object[] arr, Map<Integer, DatiVariazioneImportoCapitoloAnno> dest) {
		...
		if(!(arr[0] instanceof String)
				...
				|| !(arr[2] instanceof Integer)
				|| !(arr[3] instanceof Long)) {
		...
		Integer idVariazione = (Integer)arr[2];
