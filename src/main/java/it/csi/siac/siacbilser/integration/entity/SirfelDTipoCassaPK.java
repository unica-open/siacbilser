...
/**
 * The primary key class for the sirfel_d_tipo_cassa database table.
 * 
 */
@Embeddable
public class SirfelDTipoCassaPK extends SirfelPKBase {
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelDTipoCassaPK)) {
			return false;
		}
		SirfelDTipoCassaPK castOther = (SirfelDTipoCassaPK)other;
		return 
