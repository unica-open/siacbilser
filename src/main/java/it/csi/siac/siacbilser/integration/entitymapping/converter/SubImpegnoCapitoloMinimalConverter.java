 ...
 */
@Component
public class SubImpegnoCapitoloMinimalConverter extends ExtendedDozerConverter<SubImpegno, SiacTMovgestT> {

	/**
	 * Instantiates a new sub impegno - capitolo minimal converter.
	 */
	public SubImpegnoCapitoloMinimalConverter() {
