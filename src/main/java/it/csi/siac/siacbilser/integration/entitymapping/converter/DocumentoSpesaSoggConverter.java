...
/**
 * The Class DocumentoSpesaSoggConverter.
 */
@Component
public class DocumentoSpesaSoggConverter extends ExtendedDozerConverter<DocumentoSpesa, SiacTDoc> {
	 ...
	 */
	public DocumentoSpesaSoggConverter() {
	...
	public DocumentoSpesa convertFrom(SiacTDoc src, DocumentoSpesa dest) {
		...
		for(SiacRDocSog siacRDocSog : src.getSiacRDocSogs()){
			if(siacRDocSog.getDataCancellazione()==null) {				
				...
				soggetto.setElencoClass(new ArrayList<ClassificazioneSoggetto>());
