...
/**
 * The primary key class for the sirfel_t_riepilogo_beni database table.
 * 
 */
@Embeddable
public class SirfelTRiepilogoBeniPK extends SirfelPKBase {
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelTRiepilogoBeniPK)) {
			return false;
		}
		SirfelTRiepilogoBeniPK castOther = (SirfelTRiepilogoBeniPK)other;
		return 
