 ...
 */
@Component
public class SubdocumentoSpesaImpegnoSubimpegnoConDisponibilitaConverter extends GenericImpegnoSubimpegnoBaseConverter<SubdocumentoSpesa, SiacTSubdoc> {
	
	/**
	 * Instantiates a new subdocumento spesa impegno subimpegno converter.
	 */
	public SubdocumentoSpesaImpegnoSubimpegnoConDisponibilitaConverter() {
	...
	protected void impostaDatiAggiuntiviSubImpegno(SiacTMovgestT siacTMovgestT, SubImpegno subImpegno) {
		...
		aggiungiInformazioneDisponibilitaPagare(siacTMovgestT, subImpegno);
