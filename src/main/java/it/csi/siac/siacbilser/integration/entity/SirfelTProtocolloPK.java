...
/**
 * The primary key class for the sirfel_t_protocollo database table.
 * 
 */
@Embeddable
public class SirfelTProtocolloPK extends SirfelPKBase {
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelTProtocolloPK)) {
			return false;
		}
		SirfelTProtocolloPK castOther = (SirfelTProtocolloPK)other;
		return 
