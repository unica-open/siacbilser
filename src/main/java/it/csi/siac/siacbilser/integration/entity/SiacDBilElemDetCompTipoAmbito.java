...
@NamedQuery(name="SiacDBilElemDetCompTipoAmbito.findAll", query="SELECT s FROM SiacDBilElemDetCompTipoAmbito s")
public class SiacDBilElemDetCompTipoAmbito extends SiacTEnteBase {
	 ...
	 */
	public SiacDBilElemDetCompTipoAmbito() {
	}
