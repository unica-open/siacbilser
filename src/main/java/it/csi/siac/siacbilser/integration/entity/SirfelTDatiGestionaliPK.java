...
/**
 * The primary key class for the sirfel_t_dati_gestionali database table.
 * 
 */
@Embeddable
public class SirfelTDatiGestionaliPK extends SirfelPKBase {
...
//	private Integer enteProprietarioId;
	...
	public SirfelTDatiGestionaliPK() {
	}
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelTDatiGestionaliPK)) {
			return false;
		}
		SirfelTDatiGestionaliPK castOther = (SirfelTDatiGestionaliPK)other;
		return 
