...
public class MutuoPeriodoRimborsoDecorator extends BaseMapperDecorator<SiacTMutuo, Mutuo> {
	...
	public void decorate(SiacTMutuo s, Mutuo d) {
		d.setPeriodoRimborso(siacDMutuoPeriodoRimborsoPeriodoRimborsoMutuoMapper.map(s.getSiacDMutuoPeriodoRimborso()));
	}
}
