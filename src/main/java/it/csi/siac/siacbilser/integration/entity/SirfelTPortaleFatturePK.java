...
/**
 * The primary key class for the sirfel_t_portale_fatture database table.
 * 
 */
@Embeddable
public class SirfelTPortaleFatturePK extends SirfelPKBase {
...
//	private Integer enteProprietarioId;
	...
	public SirfelTPortaleFatturePK() {
	}
...
//	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SirfelTPortaleFatturePK)) {
			return false;
		}
		SirfelTPortaleFatturePK castOther = (SirfelTPortaleFatturePK)other;
		return 
