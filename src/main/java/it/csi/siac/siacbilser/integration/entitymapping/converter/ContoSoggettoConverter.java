...
/**
 * The Class ContoSoggettoConverter.
 */
@Component
public class ContoSoggettoConverter extends ExtendedDozerConverter<Conto, SiacTPdceConto> {
	...
	/**
	 * Instantiates a new conto soggetto converter.
	 */
	public ContoSoggettoConverter() {
