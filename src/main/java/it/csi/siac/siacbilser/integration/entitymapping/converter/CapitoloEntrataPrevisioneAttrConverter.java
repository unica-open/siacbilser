 ...
 */
@Component
public class CapitoloEntrataPrevisioneAttrConverter extends BaseAttrConverter<CapitoloEntrataPrevisione, SiacTBilElem, SiacRBilElemAttr> {
	
	/**
	 * Instantiates a new attributi bilancio attr converter.
	 */
	public CapitoloEntrataPrevisioneAttrConverter() {
