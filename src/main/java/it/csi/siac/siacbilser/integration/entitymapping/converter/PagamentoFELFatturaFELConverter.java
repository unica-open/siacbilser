...
/**
 * The Class PagamentoFELFatturaFELConverter.
 */
@Component
public class PagamentoFELFatturaFELConverter extends ExtendedDozerConverter<PagamentoFEL, SirfelTPagamento> {
	
	@Autowired
	private SirfelTFatturaRepository sirfelTFatturaRepository;
	
	public PagamentoFELFatturaFELConverter() {
		super(PagamentoFEL.class, SirfelTPagamento.class);
	}

	@Override
	public PagamentoFEL convertFrom(SirfelTPagamento src, PagamentoFEL dest) {
	...
	@Override
	public SirfelTPagamento convertTo(PagamentoFEL src, SirfelTPagamento dest) {
