...
/**
 * The Class AggiornaGestioneRelazioneAttodiLeggeServiceTest.
 */
@RunWith(Parameterized.class)
@ContextConfiguration(locations = {"/spring/bilServiceClientContext-test.xml"/*, "/spring/datasource-test.xml"*/})
public class AggiornaGestioneRelazioneAttodiLeggeServiceTest extends RelazioneAttodiLeggeMainTest 
{
	...
	/**
	 * Instantiates a new aggiorna gestione relazione attodi legge service test.
	 *
	 ...
	 */
	public AggiornaGestioneRelazioneAttodiLeggeServiceTest(String obiettivoTest, 
	...
	{       
		AggiornaRelazioneAttoDiLeggeCapitoloResponse res = aggiornaRelazioneAttoDiLeggeCapitolo();
		...
		assertNotNull("Aggiornamento fallito : Relazione Atto di Legge - Capitolo restituita null", res.getAttoDiLeggeCapitolo());
			
		//ATTO DI LEGGE
		assertNotNull("Atto di Legge restituito null da aggiornamento", res.getAttoDiLeggeCapitolo().getAttoDiLegge());
								
		//ANNO ATTO DI LEGGE
		assertNotNull("Anno Atto di Legge restituito null da aggiornamento", res.getAttoDiLeggeCapitolo().getAttoDiLegge().getAnno());
				
		//NUMERO ATTO DI LEGGE
		assertNotNull("Numero Atto di Legge restituito null da aggiornamento", res.getAttoDiLeggeCapitolo().getAttoDiLegge().getNumero());
			
		//TIPO ATTO DI LEGGE
		//assertNotNull("Tipo Atto di Legge restituito null da aggiornamento", res.getAttoDiLeggeCapitolo().getAttoDiLegge().getTipoAtto());
		
		//
	}

	/**
	 * Aggiorna relazione atto di legge capitolo.
	 *
	 * @return the aggiorna relazione atto di legge capitolo response
	 */
	private AggiornaRelazioneAttoDiLeggeCapitoloResponse aggiornaRelazioneAttoDiLeggeCapitolo() 
	{
		...
		AggiornaRelazioneAttoDiLeggeCapitoloResponse res = relazioneAttoDiLeggeCapitoloService.aggiornaRelazioneAttoDiLeggeCapitolo(req);
