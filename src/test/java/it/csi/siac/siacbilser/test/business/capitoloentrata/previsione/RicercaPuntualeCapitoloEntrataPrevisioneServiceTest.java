...
/**
 * The Class RicercaPuntualeCapitoloEntrataPrevisioneServiceTest.
 */
@RunWith(Parameterized.class)
@ContextConfiguration(locations = {"/spring/bilServiceClientContext-test.xml", "/spring/datasource-test.xml"})
public class RicercaPuntualeCapitoloEntrataPrevisioneServiceTest  extends 
		CapitoloEntrataPrevisioneMainTest
{
	...
	/**
	 * Instantiates a new ricerca puntuale capitolo entrata previsione service test.
	 *
	 ...
	 */
	public RicercaPuntualeCapitoloEntrataPrevisioneServiceTest(String obiettivoTest, 
			String uidEnte, String CFisc, String annoEser, String annoCapi, 
	...
	{       
		...
		RicercaPuntualeCapitoloEntrataPrevisioneResponse res = ricercaPuntuale(capitoloEntrataPrevisioneService);
		...
		assertNotNull("Capitolo restituito null dalla ricerca puntuale", res.getCapitoloEntrataPrevisione());
