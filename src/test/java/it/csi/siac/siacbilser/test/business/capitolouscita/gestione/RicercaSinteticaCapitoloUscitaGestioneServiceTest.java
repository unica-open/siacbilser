...
/**
 * The Class RicercaSinteticaCapitoloUscitaGestioneServiceTest.
 */
@RunWith(Parameterized.class)
@ContextConfiguration(locations = {"/spring/bilServiceClientContext-test.xml", "/spring/datasource-test.xml"})
public class RicercaSinteticaCapitoloUscitaGestioneServiceTest  extends  CapitoloUscitaGestioneMainTest 
{
	...
	/**
	 * Instantiates a new ricerca sintetica capitolo uscita gestione service test.
	 *
	 ...
	 */
	public RicercaSinteticaCapitoloUscitaGestioneServiceTest(String obiettivoTest, String uidEnte, 
	...
	{        	
		...
		RicercaSinteticaCapitoloUscitaGestioneResponse res = ricercaSinteticaCapitoloUscitaGestione();
	 ...
	 */
	private RicercaSinteticaCapitoloUscitaGestioneResponse ricercaSinteticaCapitoloUscitaGestione() {
		...
		RicercaSinteticaCapitoloUGest criteriRicerca = 
