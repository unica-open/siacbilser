...
/**
 * The Class RicercaPuntualeCapitoloUscitaPrevisioneServiceTest.
 */
@RunWith(Parameterized.class)
@ContextConfiguration(locations = {"/spring/bilServiceClientContext-test.xml"/*, "/spring/datasource-test.xml"*/})
public class RicercaPuntualeCapitoloUscitaPrevisioneServiceTest  extends CapitoloUscitaPrevisioneMainTest
{
	...
	/**
	 * Instantiates a new ricerca puntuale capitolo uscita previsione service test.
	 *
	 ...
	 */
	public RicercaPuntualeCapitoloUscitaPrevisioneServiceTest(String obiettivoTest, 
	...
	{       
		...
		RicercaPuntualeCapitoloUscitaPrevisioneResponse res = ricercaPuntuale(capitoloUscitaPrevisioneService);
		...
		assertNotNull("Capitolo restituito null dalla ricerca puntuale", res.getCapitoloUscitaPrevisione());
				
		CapitoloUscitaPrevisione capi = res.getCapitoloUscitaPrevisione();
