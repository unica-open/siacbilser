...
/**
 * The Class InserisciGestioneRelazioneAttodiLeggeServiceTest.
 */
@RunWith(Parameterized.class)
@ContextConfiguration(locations = {"/spring/bilServiceClientContext-test.xml"/*, "/spring/datasource-test.xml"*/})
public class InserisciGestioneRelazioneAttodiLeggeServiceTest extends RelazioneAttodiLeggeMainTest 
{
	...
	/**
	 * Instantiates a new inserisci gestione relazione attodi legge service test.
	 *
	 ...
	 */
	public InserisciGestioneRelazioneAttodiLeggeServiceTest(String obiettivoTest, 
		...
		String Descrizione, String Testout) 
	{
		...
		this.attoCapiDescrizione = attoCapiDescrizione;	
  		...
  		String new_descr = null;
		if (uidCapitoloEntrata != null)
		{
			new_descr = uidAttoLegge+"/"+uidCapitoloEntrata;
		}
		else
		{
			new_descr = uidAttoLegge+"/"+uidCapitoloUscita;
		}
	...
	{       
		InserisceRelazioneAttoDiLeggeCapitoloResponse res = inserisceRelazioneAttoDiLeggeCapitolo();
		...
		assertNotNull("Inserimento fallito : Relazione Atto di Legge - Capitolo restituita null", res.getAttoDiLeggeCapitolo());
			
		//ATTO DI LEGGE
		assertNotNull("Atto di Legge restituito null da inserimento", res.getAttoDiLeggeCapitolo().getAttoDiLegge());
								
		//ANNO ATTO DI LEGGE
		assertNotNull("Anno Atto di Legge restituito null da inserimento", res.getAttoDiLeggeCapitolo().getAttoDiLegge().getAnno());
				
		//NUMERO ATTO DI LEGGE
		assertNotNull("Numero Atto di Legge restituito null da inserimento", res.getAttoDiLeggeCapitolo().getAttoDiLegge().getNumero());
			
		//TIPO ATTO DI LEGGE
		//assertNotNull("Tipo Atto di Legge restituito null da inserimento", res.getAttoDiLeggeCapitolo().getAttoDiLegge().getTipoAtto());
		
		//
	}

	/**
	 * Inserisce relazione atto di legge capitolo.
	 *
	 * @return the inserisce relazione atto di legge capitolo response
	 */
	private InserisceRelazioneAttoDiLeggeCapitoloResponse inserisceRelazioneAttoDiLeggeCapitolo() 
	{
		...
		req.setAttoDiLeggeCapitolo(getAttoDiLeggeCapitolo());
				
		InserisceRelazioneAttoDiLeggeCapitoloResponse res = relazioneAttoDiLeggeCapitoloService.inserisceRelazioneAttoDiLeggeCapitolo(req);
